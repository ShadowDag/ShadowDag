...
impl OpCode {
    pub fn from_byte(b: u8) -> Self {
        match b {
            ...
            0x73 => Self::TIMESTAMP,
            0x74 => Self::BLOCKHASH,
            0x75 => Self::BLOCKHEIGHT,
            0x76 => Self::DIFFICULTY,
            0x77 => Self::CHAINID,
            0x78 => Self::SELFBALANCE,
            0x79 => Self::BASEFEE,
            0x7A => Self::ADDRESS,
            0x7B => Self::BALANCE,
            0x7C => Self::GASPRICE,
            ...
            0xB0 => Self::CALL,
            0xB1 => Self::CALLCODE,
            0xB2 => Self::DELEGATECALL,
            0xB3 => Self::STATICCALL,
            0xB4 => Self::CREATE,
            0xB5 => Self::CREATE2,
            0xB6 => Self::RETURN,
            0xB7 => Self::REVERT,
            0xB8 => Self::SELFDESTRUCT,
            0xC0 => Self::CALLDATALOAD,
            0xC1 => Self::CALLDATASIZE,
            0xC2 => Self::CALLDATACOPY,
            0xC3 => Self::CODESIZE,
            0xC4 => Self::CODECOPY,
            0xC5 => Self::EXTCODESIZE,
            0xC6 => Self::RETURNDATASIZE,
            0xC7 => Self::RETURNDATACOPY,
            0xD0 => Self::DUP2,
            0xD1 => Self::DUP3,
            0xD2 => Self::DUP4,
            0xD3 => Self::DUP5,
            ...
            0xDB => Self::SWAP8,
            0xDC => Self::SWAP16,
            0xE0 => Self::STEALTHCHECK,
            0xE1 => Self::RINGPROOF,
            0xE2 => Self::CTVERIFY,
            0xE3 => Self::DAGTIPS,
            0xE4 => Self::DAGBPS,
            0xE5 => Self::ATOMICSWAP,
            0xEF => Self::DEBUG,
            _ => Self::INVALID,
        }
    }
    ...
    pub fn gas_cost(&self) -> u64 {
        match self {
            ...
            Self::SLOAD | Self::SSIZE | Self::BALANCE | Self::SELFBALANCE | Self::EXTCODESIZE => {
                200
            }
    ...
    pub fn stack_pop(&self) -> usize {
        match self {
            ...
            Self::DUP16 | Self::SWAP16 | Self::RINGPROOF | Self::CTVERIFY | Self::ATOMICSWAP => 16,
            Self::INVALID => 0,
        }
    }
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Self::SWAP8 => "SWAP8",
            Self::SWAP16 => "SWAP16",
            Self::STEALTHCHECK => "STEALTHCHECK",
            Self::RINGPROOF => "RINGPROOF",
            Self::CTVERIFY => "CTVERIFY",
            Self::DAGTIPS => "DAGTIPS",
            Self::DAGBPS => "DAGBPS",
    ...
    pub fn is_terminating(&self) -> bool {
        matches!(
            self,
            Self::STOP | Self::RETURN | Self::REVERT | Self::SELFDESTRUCT | Self::INVALID
        )
    }
